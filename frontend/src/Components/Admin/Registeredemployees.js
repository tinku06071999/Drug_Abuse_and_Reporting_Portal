    ...
    <div className="flex-1 min-h-screen bg-slate-950 text-slate-200">
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="flex gap-3">
          ...
          <FilterButton active={filterType === "verified"} color="green" onClick={() => setFilterType("verified")}>
            Verified
          </FilterButton>
          <FilterButton active={filterType === "pending"} color="red" onClick={() => setFilterType("pending")}>
            Pending
          </FilterButton>
        </div>
          ...
          <div className="overflow-auto max-h-[65vh]">
            <table className="min-w-full text-sm">
              ...
              <tbody>
                ...
                {!loading && filteredEmployees.map((e, index) => (
                  <tr
                    key={e.userId}
                  ...
                  >
                    ...
                    <Td>
                      <StatusBadge status={e.verified ? "Verified" : "Pending"} />
                    </Td>
                    ...
                    <Td>
                      <div className="flex gap-2">
                        ...
                        <ActionButton
                          disabled={updatingId === e.userId}
                          color={e.roles?.includes("ADMIN") ? "red" : "cyan"}
                          onClick={() => handleMakeAdmin(e.userId)}
                        >
                          {e.roles?.includes("ADMIN") ? "Remove Admin" : "Make Admin"}
                        </ActionButton>
                      </div>
                    </Td>
                  </tr>
